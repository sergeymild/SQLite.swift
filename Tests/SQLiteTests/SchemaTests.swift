...
class SchemaTests : XCTestCase {
    ...
    func test_create_withBuilder_compilesCreateTableExpression() {
        XCTAssertEqual(
            ...
            table.create {
                ...
                column(dataOptional)
                column(double)
                column(doubleOptional)
                column(int64)
                column(int64Optional)
                column(string)
        ...
        XCTAssertEqual(
            ...
            table.create(temporary: true) { column(int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE IF NOT EXISTS \"table\" (\"int64\" INTEGER NOT NULL)",
            table.create(ifNotExists: true) { column(int64) }
        )
        XCTAssertEqual(
            "CREATE TEMPORARY TABLE IF NOT EXISTS \"table\" (\"int64\" INTEGER NOT NULL)",
            table.create(temporary: true, ifNotExists: true) { column(int64) }
        )

        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL) WITHOUT ROWID",
            table.create(withoutRowid: true) { column(int64) }
        )
        XCTAssertEqual(
            "CREATE TEMPORARY TABLE IF NOT EXISTS \"table\" (\"int64\" INTEGER NOT NULL) WITHOUT ROWID",
            table.create(temporary: true, ifNotExists: true, withoutRowid: true) { column(int64) }
        )
    }
    ...
    func test_column_compilesColumnDefinitionExpression() {
        ...
        XCTAssertEqual(
            ...
            table.create { column(int64, primaryKey: true, check: int64 > 0, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER PRIMARY KEY NOT NULL CHECK (\"int64Optional\" > 0) DEFAULT (\"int64\"))",
            table.create { column(int64, primaryKey: true, check: int64Optional > 0, defaultValue: int64) }
        )

        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER)",
            table.create { column(int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE)",
            table.create { column(int64Optional, unique: true) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64\" > 0))",
            table.create { column(int64Optional, check: int64 > 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64Optional\" > 0))",
            table.create { column(int64Optional, check: int64Optional > 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER DEFAULT (\"int64\"))",
            table.create { column(int64Optional, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER DEFAULT (\"int64Optional\"))",
            table.create { column(int64Optional, defaultValue: int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER DEFAULT (0))",
            table.create { column(int64Optional, defaultValue: 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64\" > 0))",
            table.create { column(int64Optional, unique: true, check: int64 > 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64Optional\" > 0))",
            table.create { column(int64Optional, unique: true, check: int64Optional > 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE DEFAULT (\"int64\"))",
            table.create { column(int64Optional, unique: true, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE DEFAULT (\"int64Optional\"))",
            table.create { column(int64Optional, unique: true, defaultValue: int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE DEFAULT (0))",
            table.create { column(int64Optional, unique: true, defaultValue: 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64\" > 0))",
            table.create { column(int64Optional, unique: true, check: int64 > 0) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(int64Optional, unique: true, check: int64 > 0, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64\" > 0) DEFAULT (\"int64Optional\"))",
            table.create { column(int64Optional, unique: true, check: int64 > 0, defaultValue: int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64Optional\" > 0) DEFAULT (\"int64\"))",
            table.create { column(int64Optional, unique: true, check: int64Optional > 0, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64Optional\" > 0) DEFAULT (\"int64Optional\"))",
            table.create { column(int64Optional, unique: true, check: int64Optional > 0, defaultValue: int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64\" > 0) DEFAULT (0))",
            table.create { column(int64Optional, unique: true, check: int64 > 0, defaultValue: 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64Optional\" > 0) DEFAULT (0))",
            table.create { column(int64Optional, unique: true, check: int64Optional > 0, defaultValue: 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64\" > 0) DEFAULT (\"int64\"))",
            table.create { column(int64Optional, check: int64 > 0, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64Optional\" > 0) DEFAULT (\"int64\"))",
            table.create { column(int64Optional, check: int64Optional > 0, defaultValue: int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64\" > 0) DEFAULT (\"int64Optional\"))",
            table.create { column(int64Optional, check: int64 > 0, defaultValue: int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64Optional\" > 0) DEFAULT (\"int64Optional\"))",
            table.create { column(int64Optional, check: int64Optional > 0, defaultValue: int64Optional) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64\" > 0) DEFAULT (0))",
            table.create { column(int64Optional, check: int64 > 0, defaultValue: 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64Optional\" > 0) DEFAULT (0))",
            table.create { column(int64Optional, check: int64Optional > 0, defaultValue: 0) }
        )
    }
    ...
    func test_column_withIntegerExpression_compilesPrimaryKeyAutoincrementColumnDefinitionExpression() {
        XCTAssertEqual(
            ...
            table.create { column(int64, primaryKey: .autoincrement) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL CHECK (\"int64\" > 0))",
            table.create { column(int64, primaryKey: .autoincrement, check: int64 > 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL CHECK (\"int64Optional\" > 0))",
            table.create { column(int64, primaryKey: .autoincrement, check: int64Optional > 0) }
        )
    }
    ...
    func test_column_withIntegerExpression_compilesReferentialColumnDefinitionExpression() {
        XCTAssertEqual(
            ...
            table.create { column(int64, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64, references: qualifiedTable, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL UNIQUE REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64, unique: true, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL CHECK (\"int64\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64, check: int64 > 0, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL CHECK (\"int64Optional\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64, check: int64Optional > 0, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL UNIQUE CHECK (\"int64\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64, unique: true, check: int64 > 0, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64\" INTEGER NOT NULL UNIQUE CHECK (\"int64Optional\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64, unique: true, check: int64Optional > 0, references: table, int64) }
        )

        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64Optional, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64Optional, unique: true, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64Optional, check: int64 > 0, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER CHECK (\"int64Optional\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64Optional, check: int64Optional > 0, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64Optional, unique: true, check: int64 > 0, references: table, int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"int64Optional\" INTEGER UNIQUE CHECK (\"int64Optional\" > 0) REFERENCES \"table\" (\"int64\"))",
            table.create { column(int64Optional, unique: true, check: int64Optional > 0, references: table, int64) }
        )
    }
    ...
    func test_column_withStringExpression_compilesReferentialColumnDefinitionExpression() {
        XCTAssertEqual(
            ...
            table.create { column(string, references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL REFERENCES \"table\" (\"string\"))",
            table.create { column(string, references: qualifiedTable, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE REFERENCES \"table\" (\"string\"))",
            table.create { column(string, unique: true, references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL CHECK (\"string\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(string, check: string != "", references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL CHECK (\"stringOptional\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(string, check: stringOptional != "", references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE CHECK (\"string\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(string, unique: true, check: string != "", references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE CHECK (\"stringOptional\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(string, unique: true, check: stringOptional != "", references: table, string) }
        )

        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT REFERENCES \"table\" (\"string\"))",
            table.create { column(stringOptional, references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE REFERENCES \"table\" (\"string\"))",
            table.create { column(stringOptional, unique: true, references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"string\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(stringOptional, check: string != "", references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"stringOptional\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(stringOptional, check: stringOptional != "", references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"string\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(stringOptional, unique: true, check: string != "", references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"stringOptional\" != '') REFERENCES \"table\" (\"string\"))",
            table.create { column(stringOptional, unique: true, check: stringOptional != "", references: table, string) }
        )
    }
    ...
    func test_column_withStringExpression_compilesCollatedColumnDefinitionExpression() {
        ...
        XCTAssertEqual(
            ...
            table.create { column(string, unique: true, check: string != "", collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE CHECK (\"stringOptional\" != '') COLLATE RTRIM)",
            table.create { column(string, unique: true, check: stringOptional != "", collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(string, unique: true, defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(string, unique: true, defaultValue: "string", collate: .rtrim) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(string, unique: true, check: string != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE CHECK (\"stringOptional\" != '') DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(string, unique: true, check: stringOptional != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL UNIQUE CHECK (\"string\" != '') DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(string, unique: true, check: string != "", defaultValue: "string", collate: .rtrim) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(string, check: string != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL CHECK (\"stringOptional\" != '') DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(string, check: stringOptional != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"string\" TEXT NOT NULL CHECK (\"string\" != '') DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(string, check: string != "", defaultValue: "string", collate: .rtrim) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"string\" != '') COLLATE RTRIM)",
            table.create { column(stringOptional, check: string != "", collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"stringOptional\" != '') COLLATE RTRIM)",
            table.create { column(stringOptional, check: stringOptional != "", collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(stringOptional, defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT DEFAULT (\"stringOptional\") COLLATE RTRIM)",
            table.create { column(stringOptional, defaultValue: stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(stringOptional, defaultValue: "string", collate: .rtrim) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(stringOptional, unique: true, check: string != "", collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"stringOptional\" != '') COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, check: stringOptional != "", collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE DEFAULT (\"stringOptional\") COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, defaultValue: stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, defaultValue: "string", collate: .rtrim) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(stringOptional, unique: true, check: string != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"string\" != '') DEFAULT (\"stringOptional\") COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, check: string != "", defaultValue: stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"stringOptional\" != '') DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, check: stringOptional != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"stringOptional\" != '') DEFAULT (\"stringOptional\") COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, check: stringOptional != "", defaultValue: stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT UNIQUE CHECK (\"string\" != '') DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(stringOptional, unique: true, check: string != "", defaultValue: "string", collate: .rtrim) }
        ...
        XCTAssertEqual(
            ...
            table.create { column(stringOptional, check: string != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"stringOptional\" != '') DEFAULT (\"string\") COLLATE RTRIM)",
            table.create { column(stringOptional, check: stringOptional != "", defaultValue: string, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"string\" != '') DEFAULT (\"stringOptional\") COLLATE RTRIM)",
            table.create { column(stringOptional, check: string != "", defaultValue: stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"stringOptional\" != '') DEFAULT (\"stringOptional\") COLLATE RTRIM)",
            table.create { column(stringOptional, check: stringOptional != "", defaultValue: stringOptional, collate: .rtrim) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (\"stringOptional\" TEXT CHECK (\"string\" != '') DEFAULT ('string') COLLATE RTRIM)",
            table.create { column(stringOptional, check: string != "", defaultValue: "string", collate: .rtrim) }
    ...
    func test_primaryKey_compilesPrimaryKeyExpression() {
        XCTAssertEqual(
            ...
            table.create { primaryKey(int64) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (PRIMARY KEY (\"int64\", \"string\"))",
            table.create { primaryKey(int64, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (PRIMARY KEY (\"int64\", \"string\", \"double\"))",
            table.create { primaryKey(int64, string, double) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (PRIMARY KEY (\"int64\", \"string\", \"double\", \"date\"))",
            table.create { primaryKey(int64, string, double, date) }
        )
    }
    ...
    func test_check_compilesCheckExpression() {
        XCTAssertEqual(
            ...
            table.create { check(int64 > 0) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (CHECK ((\"int64Optional\" > 0)))",
            table.create { check(int64Optional > 0) }
        )
    }
    ...
    func test_foreignKey_compilesForeignKeyExpression() {
        XCTAssertEqual(
            ...
            table.create { foreignKey(string, references: table, string) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (FOREIGN KEY (\"stringOptional\") REFERENCES \"table\" (\"string\"))",
            table.create { foreignKey(stringOptional, references: table, string) }
        )

        XCTAssertEqual(
            "CREATE TABLE \"table\" (FOREIGN KEY (\"string\") REFERENCES \"table\" (\"string\") ON UPDATE CASCADE ON DELETE SET NULL)",
            table.create { foreignKey(string, references: table, string, update: .cascade, delete: .setNull) }
        )

        XCTAssertEqual(
            "CREATE TABLE \"table\" (FOREIGN KEY (\"string\", \"string\") REFERENCES \"table\" (\"string\", \"string\"))",
            table.create { foreignKey((string, string), references: table, (string, string)) }
        )
        XCTAssertEqual(
            "CREATE TABLE \"table\" (FOREIGN KEY (\"string\", \"string\", \"string\") REFERENCES \"table\" (\"string\", \"string\", \"string\"))",
            table.create { foreignKey((string, string, string), references: table, (string, string, string)) }
        )
    }
